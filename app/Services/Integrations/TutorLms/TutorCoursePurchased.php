...
class TutorCoursePurchased extends BaseCondition
{
    public function __construct()
    {
        $this->conditionName = 'fcrm_tutor_is_in_course';
        $this->priority = 30;
        parent::__construct();
    }
    ...
    {
        return [
            'title'            => __('[TutorLMS] Check if the contact enroll a course', 'fluentcampaign-pro'),
    ...
    {
        return [
            'title'     => __('[TutorLMS] Check if the contact enrolled a course', 'fluentcampaign-pro'),
            'sub_title' => __('Conditionally check if contact enrolled a course', 'fluentcampaign-pro'),
            'fields'    => [
                'course_ids'        => [
                    'type'        => 'multi-select',
