...
class WooOrderSuccessTrigger extends BaseTrigger
{
    public function __construct()
    {
        ...
        add_action('fluentcrm_funnel_start_woocommerce_order_status_completed', array($this, 'handle'), 10, 2);
    }
    ...
    {
        return [
            'title'     => __('New WooCommerce Order (Processing) has been places', 'fluentcampaign-pro'),
            'sub_title' => __('This Funnel will start once new order will be marked as successful payment', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status'      => [
