...
class WooInit
{
    public function init()
    {
        ...
        new \FluentCampaign\App\Services\Integrations\WooCommerce\WooPurchased();
        ...
        new \FluentCampaign\App\Services\Integrations\WooCommerce\WooConditions();
        ...
        add_action( 'woocommerce_checkout_billing', array($this, 'addSubscribeBox'), 999 );
    ...
    public function maybeRecordPayment($orderId, $order)
    {
        ...
        if ($campaignId) {
            ...
            $order->update_meta_data('_fc_sid', 'yes');
