...
class RCPMembershipTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'rcp_membership_post_activate';
        $this->priority = 14;
        $this->actionArgNum = 2;
        parent::__construct();
    }
    ...
    public function getSettingsFields($funnel)
    {
        return [
            ...
            'sub_title' => __('This funnel will start when a member is added to a level for the first time', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status' => [
