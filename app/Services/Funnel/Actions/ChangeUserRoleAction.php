...
class ChangeUserRoleAction extends BaseAction
{
    ...
    public function getBlock()
    {
        return [
            ...
            'icon'        => fluentCrmMix('images/funnel_icons/wp_user_role.svg'),
            'settings'    => [
                'user_role' => '',
                'replace'   => 'yes'
            ]
        ...
        return [
            ...
            'fields'    => [
                'user_role'                    => [
                    ...
                    'inline_help' => 'Selected Role will be applied if there has a user with contact\'s email address'
                ],
                'replace'       => [
                    'type'        => 'yes_no_check',
                    'label'       => 'Replace Existing Role',
                    'check_label' => __('Replace user role ', 'fluentcampaign-pro'),
                    'inline_help' => 'If you disable this then it will append the selected role with existing roles.'
                ]
            ]
        ];
    }
